...
namespace SCG.ARS.BOI.WEB.Helpers
{
    public static class Extensions
    {
        ...
        {
            DateTime ldowDate = FirstDayOfWeek(dt, startOfWeek);
            return ldowDate;
        }
        ...
        {
            return new DateTime(value.Year, value.Month, 1).AddMonths(-1);
        }
        ...
        public static DateTime LastDayOfLastMonth(this DateTime value)
        {
        ...
        public static Boolean MappingCompare(this string logic, string x, string y)
        {
            switch (logic)
            {
                case "=":
        ...
        public static JobDataMapItemBase[] GetModel(this IEnumerable<Dictionary<string, object>> formData, Quartzmin.Services services)
        {
        ...
        public static List<JobDataMapItem> GetJobDataMapModel(this IJobDetail job, Quartzmin.Services services) => GetJobDataMapModelCore(job, services);
        public static List<JobDataMapItem> GetJobDataMapModel(this ITrigger trigger, Quartzmin.Services services) => GetJobDataMapModelCore(trigger, services);

        private static List<JobDataMapItem> GetJobDataMapModelCore(object jobOrTrigger, Quartzmin.Services services)
        {
