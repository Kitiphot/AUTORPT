...
namespace SCG.ARS.BOI.WEB.Helpers
{
    public class Pages
    {
        ...
        public static Pages RPT002_StockOnHandReport { get { return new Pages("RPT002", "RPT002"); } }
        ...
        public static Pages UsersMaintenance { get { return new Pages("UsersMaintenance", "UsersMaintenance"); } }
        public static Pages Quartzmin { get { return new Pages("Quartzmin", "Quartzmin"); } }

        //Template Mapping
        public static Pages TemplateMapping { get { return new Pages("Index", "TemplateMapping"); } }
    }
}
