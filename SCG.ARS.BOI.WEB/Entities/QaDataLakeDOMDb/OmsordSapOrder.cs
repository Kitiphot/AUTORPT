...
{
    public partial class OmsordSapOrder
    {
        ...
        public string Omsdestlocationcode { get; set; }
        public string Omsdestlocationname { get; set; }
        public string Omsdestlocationhouseno { get; set; }
        public string Omsdestlocationsoi { get; set; }
        public string Omsdestlocationstreet { get; set; }
        public string Omsdestlocationpostalcode { get; set; }
        public int? Omsdestlocationregion { get; set; }
        public string Omsdestlocationregionname { get; set; }
        public string Omsdestlocationrecipient { get; set; }
        public string Omsdestlocationtelephone { get; set; }
        public string Omsdestlocationmobile { get; set; }
        public string Omsdestlocationspecialcond { get; set; }
