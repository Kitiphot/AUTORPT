...
namespace SCG.ARS.BOI.WEB.Services
{
    ...
    {
        private static readonly string AuthorityUrl = "https://login.microsoftonline.com/common/";//ConfigurationManager.AppSettings["authorityUrl"];
        ...
        private static readonly string ApplicationId = "714387c0-34f8-4abf-8eef-2001779b0a8e";//ConfigurationManager.AppSettings["applicationId"];
        private static readonly string ApiUrl = "https://api.powerbi.com";// ConfigurationManager.AppSettings["apiUrl"];
        private static readonly string WorkspaceId = "734087f2-6f75-40ae-ac9e-667de1828e85";// ConfigurationManager.AppSettings["workspaceId"];
        private static readonly string ReportId = "f5ed8a64-898d-4bfa-8347-0fc95b92a189";//ConfigurationManager.AppSettings["reportId"];

        private static readonly string AuthenticationType = "MasterUser";// ConfigurationManager.AppSettings["AuthenticationType"];
        ...
        private static readonly string ApplicationSecret = null;// sectionConfig["applicationSecret"];
        private static readonly string Tenant = null;// sectionConfig["tenant"];
        private static readonly string Username = "PATIPOLS@SCG.COM";// sectionConfig["pbiUsername"];
        private static readonly string Password = "Maxky005$$";// sectionConfig["pbiPassword"];

        public PowerBIEmbedConfigModel EmbedConfig
        {
        ...
        private PowerBIEmbedConfigModel m_embedConfig;
        ...
        public PowerBIEmbedService()
        {
            ...
            m_embedConfig = new PowerBIEmbedConfigModel();
        ...
        private async Task<AuthenticationResult> DoAuthentication()
        {
            ...
            if (AuthenticationType.Equals("MasterUser"))
            {
                ...
                //var credential = new Microsoft.IdentityModel.Clients.ActiveDirectory.UserPasswordCredential(Username, Password);
